...
var Ane = require('./ane');   // 依赖 ane
var Baby = require('./baby');   // 依赖 baby
var Dust = require('./dust');   // 依赖 dust
var Fruit = require('./fruit');   // 依赖 fruit
var Halo = require('./halo');   // 依赖 halo
var Mom = require('./mom');   // 依赖 mom
var Score = require('./score');   // 依赖 score
var Wave = require('./wave');   // 依赖 wave
...
module.exports = Controller;    //暴露Controllers